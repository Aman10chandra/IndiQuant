...
const ALL_STOCKS = [
  { ticker: 'TCS', name: 'Tata Consultancy Services Ltd.', sector: 'Technology', sectorCode: 'TECH', price: 2361.00, change_pct: -0.59, pe: 31.4, mcap: '₹8.5L Cr' },
  ...
  { ticker: 'INFY', name: 'Infosys Limited', sector: 'Technology', sectorCode: 'TECH', price: 1169.20, change_pct: -0.49, pe: 28.2, mcap: '₹4.7L Cr' },
  { ticker: 'HDFCBANK', name: 'HDFC Bank Ltd.', sector: 'Financials', sectorCode: 'FINANCE', price: 727.00, change_pct: 0.28, pe: 19.8, mcap: '₹11.2L Cr' },
  { ticker: 'ICICIBANK', name: 'ICICI Bank Ltd.', sector: 'Financials', sectorCode: 'FINANCE', price: 1417.00, change_pct: 0.72, pe: 18.2, mcap: '₹9.9L Cr' },
  { ticker: 'BAJFINANCE', name: 'Bajaj Finance Ltd.', sector: 'Financials', sectorCode: 'FINANCE', price: 1087.00, change_pct: -0.35, pe: 34.2, mcap: '₹6.8L Cr' },
  ...
  { ticker: 'SBIN', name: 'State Bank of India', sector: 'Financials', sectorCode: 'FINANCE', price: 1067.70, change_pct: -1.41, pe: 10.4, mcap: '₹9.8L Cr' },
  { ticker: 'WIPRO', name: 'Wipro Limited', sector: 'Technology', sectorCode: 'TECH', price: 184.00, change_pct: 0.49, pe: 22.4, mcap: '₹1.8L Cr' },
  { ticker: 'HCLTECH', name: 'HCL Technologies Ltd.', sector: 'Technology', sectorCode: 'TECH', price: 1360.00, change_pct: -0.73, pe: 24.8, mcap: '₹3.7L Cr' },
  ...
  { ticker: 'POWERGRID', name: 'Power Grid Corporation of India', sector: 'Energy', sectorCode: 'ENERGY', price: 266.05, change_pct: -0.21, pe: 18.2, mcap: '₹2.5L Cr' },
  { ticker: 'M&M', name: 'Mahindra & Mahindra Ltd.', sector: 'Automotive', sectorCode: 'AUTO', price: 3428.30, change_pct: 0.00, pe: 31.2, mcap: '₹4.3L Cr' },
  { ticker: 'MARUTI', name: 'Maruti Suzuki India Ltd.', sector: 'Automotive', sectorCode: 'AUTO', price: 13834.00, change_pct: -0.51, pe: 28.4, mcap: '₹4.3L Cr' },
  { ticker: 'HINDUNILVR', name: 'Hindustan Unilever Ltd.', sector: 'FMCG', sectorCode: 'FMCG', price: 2077.00, change_pct: -0.72, pe: 58.4, mcap: '₹4.9L Cr' },
  { ticker: 'ITC', name: 'ITC Limited', sector: 'FMCG', sectorCode: 'FMCG', price: 278.20, change_pct: -0.11, pe: 28.6, mcap: '₹3.5L Cr' },
  { ticker: 'LT', name: 'Larsen & Toubro Ltd.', sector: 'Infrastructure', sectorCode: 'INFRA', price: 4057.00, change_pct: -0.34, pe: 32.5, mcap: '₹5.6L Cr' },
  { ticker: 'BHARTIARTL', name: 'Bharti Airtel Ltd.', sector: 'Telecom', sectorCode: 'TELECOM', price: 1992.10, change_pct: 2.73, pe: 64.2, mcap: '₹11.8L Cr' },
];
